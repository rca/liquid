...
== Liquid and the ecosystem

Liquid unit tests successfully run in the following versions of the Ruby language: 1.8.7, 1.9.1 and 1.9.2.
Version 2.1 of the Liquid gem is _currently_ being tested with Ruby on Rails 3 beta 4.

== How to contribute

  * If you have any issues, please use Github's issue tracker on this project
  * Feel free to contribute with code. Fork the project and make your changes (with tests).